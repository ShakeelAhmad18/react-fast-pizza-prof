...
function Button({children,disabled,to,type}) {
     ...
     const styles={
       ...
       base:'bg-stone-400 tracking-wide rounded-full text-stone-800 py-2 px-3 font-semibold duration-500 inline-block uppercase focus:bg-stone-300 focus:ring focus:outline-none focus:ring-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed md:py-4 md:px-6'
     }
