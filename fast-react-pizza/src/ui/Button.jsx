...
function Button({children,disabled,to,type,onClick}) {
     ...
     const styles={
       ...
       round:'bg-yellow-400 tracking-wide rounded-full text-stone-800 py-1 px-2.1 text-xs font-semibold duration-500 inline-block uppercase focus:bg-yellow-300 focus:ring focus:outline-none focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed md:py-2.5 md:px-3.5'
     }
