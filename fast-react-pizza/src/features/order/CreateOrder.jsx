...
function CreateOrder() {
   ...
   const isLoading=addressStatus === 'loading'
    ...
    return (
        <div>
            <h2 className='py-3 px-6 text-xl font-semibold'>Ready to order? Let's go</h2>
            ...
            <Form method='POST'>
                ...
                <div className='mb-12 flex items-center gap-5'>
                    <input className='my-3 mx-2 h-6 w-6 accent-yellow-400 focus:outline-none focus:ring focus:ring-offset-2 focus:ring-yellow-400' type="checkbox" value={withPriority} onClick={(e)=>setWithPriority(e.target.checked)}  name="priority" id="priority" />
